...
// TODO: Hide behind some appropriate ifdef
#include "CudaAPI.cc"
...
void QCS::setCornerDiv(
    ...
    const int* mapsp2 = mesh->mapsp2;
    const int* mapsz = mesh->mapsz;
    const int* mapss3 = mesh->mapss3;
    const int* mapse = mesh->mapse;
